...
namespace PuntoDeVentaV2
{
    class TablasMySQL
    {
        ...
        public void buildListTables()
        {
            // 01 Tabla de usuarios
            tables.Add(@"CREATE TABLE IF NOT EXISTS Usuarios (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Productos (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS ProductoRelacionadoXML (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS HistorialCompras (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS HistorialModificacionRecordProduct (
                            ID INTEGER  PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            IDUsuario INTEGER,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS HistorialPrecios (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS MensajesInventario (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER NOT NULL,
                            IDProducto INTEGER NOT NULL,
                            Mensaje TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS ProductMessage (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS ProductosDeServicios (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            Fecha DATETIME NOT NULL,
                            IDServicio INTEGER,
                            IDProducto INTEGER,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Clientes (
                            ID INTEGER  PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER NOT NULL,
                            RazonSocial TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Empleados (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER NOT NULL,
                            nombre TEXT,
                            usuario TEXT NOT NULL,
            ...
            // 12 Tabla de Ventas
            tables.Add(@"CREATE TABLE IF NOT EXISTS Ventas (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            IDUsuario INTEGER NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS ProductosVenta (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Proveedores (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER NOT NULL,
                            Nombre TEXT NOT NULL,
                            RFC TEXT NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS DetallesProducto (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDProducto INTEGER NOT NULL,
                            IDUsuario INTEGER NOT NULL,
                            Proveedor TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS DetalleGeneral (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS DetallesProductoGenerales (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDProducto INTEGER NOT NULL,
                            IDUsuario INTEGER NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS DetallesVenta (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDVenta INTEGER NOT NULL,
                            IDUsuario INTEGER,
            ...
            // 19 Tabla de Abonos
            tables.Add(@"CREATE TABLE IF NOT EXISTS Abonos (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDVenta INTEGER  NOT NULL,
                            IDUsuario INTEGER,
                            Total DECIMAL (16, 2) DEFAULT (0),
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Anticipos (
                            ID INTEGER  PRIMARY KEY AUTO_INCREMENT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Catalogo_claves_producto (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            clave TEXT,
                            descripcion TEXT
                        );");
            // 24 Tabla de Catalogo_monedas
            tables.Add(@"CREATE TABLE IF NOT EXISTS Catalogo_monedas (
                            clave_moneda VARCHAR(50) NOT NULL,
                            descripcion    TEXT,
                            cant_decimales INTEGER
                        );");
            // 25 Tabla de CatalogoUnidadesMedida
            tables.Add(@"CREATE TABLE IF NOT EXISTS CatalogoUnidadesMedida (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            ClaveUnidad TEXT,
                            Nombre      TEXT
                        );");
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS CodigoBarrasExtras (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS CodigoBarrasGenerado (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER,
                            CodigoBarras TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS ConceptosDinamicos (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER  NOT NULL,
                            IDEmpleado INTEGER  DEFAULT (0),
                            Concepto TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Configuracion (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario INTEGER NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS CorreosProducto (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            IDUsuario INTEGER NOT NULL,
                            IDEmpleado INTEGER DEFAULT (0),
                            IDProducto INTEGER NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS DescuentoCliente (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS DescuentoMayoreo (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            RangoInicial TEXT,
                            RangoFinal TEXT,
                            Precio DECIMAL (16, 2) DEFAULT (0),
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS DetallesFacturacionProductos (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            Tipo TEXT,
                            Impuesto TEXT,
                            TipoFactor TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS EmpleadosPermisos (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Empresas (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Facturas (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            id_usuario INTEGER,
                            id_venta INTEGER,
                            id_empleado INTEGER,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Facturas_complemento_pago (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Facturas_productos (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
                            id_factura INTEGER,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS Facturas_impuestos (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS FiltroDinamico (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            concepto TEXT,
                            checkBoxConcepto INTEGER NOT NULL DEFAULT (0),
                            textCantidad TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS FiltroProducto (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
                            concepto TEXT,
                            checkBoxConcepto INTEGER NOT NULL DEFAULT (0),
                            textComboBoxConcepto TEXT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS FiltrosDinamicosVetanaFiltros (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS RegimenFiscal (
                            ID INTEGER PRIMARY KEY AUTO_INCREMENT,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS RegimenDeUsuarios (
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS RevisarInventario (
                            ID INTEGER  PRIMARY KEY AUTO_INCREMENT NOT NULL,
            ...
            tables.Add(@"CREATE TABLE IF NOT EXISTS TipoClientes (
                            ID                  INTEGER  PRIMARY KEY AUTO_INCREMENT,
                            IDUsuario           INTEGER  NOT NULL DEFAULT (0),
                            Nombre              TEXT     NOT NULL,
