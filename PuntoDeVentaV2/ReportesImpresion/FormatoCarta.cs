...
{
    public class FormatoCarta : IDisposable
    {
        ...
        {
            string deviceInfo = @"<DeviceInfo><OutputFormat>EMF</OutputFormat><PageWith>8in</PageWith><PageHeight>10in</PageHeight><MarginTop>1cm</MarginTop><MarginLeft>0cm</MarginLeft><MarginRight>0cm</MarginRight><MarginBottom>1cm</MarginBottom></DeviceInfo>";
