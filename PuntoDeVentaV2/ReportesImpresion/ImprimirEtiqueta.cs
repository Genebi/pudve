...
{
    public class ImprimirEtiqueta : IDisposable
    {
        ...
        {
            string deviceInfo = @"<DeviceInfo><OutputFormat>EMF</OutputFormat><PageWith>3.5in</PageWith><PageHeight>1.14in</PageHeight><MarginTop>0cm</MarginTop><MarginLeft>0cm</MarginLeft><MarginRight>0cm</MarginRight><MarginBottom>0cm</MarginBottom></DeviceInfo>";
