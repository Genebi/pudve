    ...
    public partial class FechasReportes : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (cbEmpleados.SelectedIndex.Equals(0))
            {
                ...
                {
                    MessageBox.Show("No se encontraron ventas realizadas\nen las fechas indicadas.", "Mensaje del sistema", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                ...
                using (DataTable dt = cn.CargarDatos($"SELECT Fecha FROM historialstock WHERE idComboServicio = {Productos.idProductoHistorialStock} AND Fecha < '2023-02-20'"))
                {
                    if (dt.Rows.Count > 0)
                    {
                        MessageBox.Show("Solamente se podrán ver las ventas a partir de la actualización de Febrero de 2023", "Mensaje del sistema", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
