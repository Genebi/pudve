    ...
    class Consultas
    {
        ...
        public string GuardarVenta(string[] datos, int operacion = 0)
        {
            ...
            if (operacion == 0)
            {
                ...
                consulta = "INSERT INTO Ventas (IDUsuario, IDCliente, IDSucursal, Subtotal, IVA16, Total, Descuento, DescuentoGeneral, Anticipo, Folio, Serie, Status, FechaOperacion, IDClienteDescuento)";
