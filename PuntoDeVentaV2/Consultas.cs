...
namespace PuntoDeVentaV2
{
    class Consultas
    {
        ...
        public string GuardarHistorialPrecios(string[] datos)
       {
        ...
        {
            var consulta = $"( SELECT Vent.IDEmpleado, FORMAT( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ), 2 ) AS 'Efectivo', FORMAT( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ), 2 ) AS 'Tarjeta', FORMAT( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ), 2 ) AS 'Vales', FORMAT( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ), 2 ) AS 'Cheque', FORMAT( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ) ) + ( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ) ) + ( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ) ) + ( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ) ) + ( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ) ) ), 2 ) AS 'Total' FROM Abonos AS Abono INNER JOIN Ventas AS Vent ON ( Vent.ID = Abono.IDVenta ) WHERE Abono.IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND FormaPago = 'Crédito' AND FechaOperacion > '{ultimaFechaDeCorte}' ) AND Abono.IDEmpleado = '0' ) UNION DISTINCT ( SELECT Vent.IDEmpleado, FORMAT( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ), 2 ) AS 'Efectivo', FORMAT( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ), 2 ) AS 'Tarjeta', FORMAT( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ), 2 ) AS 'Vales', FORMAT( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ), 2 ) AS 'Cheque', FORMAT( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ) ) + ( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ) ) + ( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ) ) + ( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ) ) + ( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ) ) ), 2 ) AS 'Total' FROM Abonos AS Abono INNER JOIN Ventas AS Vent ON ( Vent.ID = Abono.IDVenta ) WHERE Abono.ID IN ( SELECT ID FROM abonos WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND FechaOperacion > '{ultimaFechaDeCorte}' AND IDVenta NOT IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND FormaPago = 'Crédito' AND FechaOperacion > '{ultimaFechaDeCorte}' ) ) )";
        ...
        {
            var consulta = $"( SELECT Abono.IDEmpleado, FORMAT( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ), 2 ) AS 'Efectivo', FORMAT( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ), 2 ) AS 'Tarjeta', FORMAT( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ), 2 ) AS 'Vales', FORMAT( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ), 2 ) AS 'Cheque', FORMAT( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ) ) + ( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ) ) + ( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ) ) + ( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ) ) + ( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ) ) ), 2 ) AS 'Total' FROM Abonos AS Abono INNER JOIN Ventas AS Vent ON ( Vent.ID = Abono.IDVenta ) WHERE Abono.IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{idEmpleado}' AND FormaPago = 'Crédito' AND FechaOperacion > '{ultimaFechaDeCorte}' ) AND Abono.IDEmpleado = '{idEmpleado}' ) UNION DISTINCT ( SELECT Abono.IDEmpleado, FORMAT( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ), 2 ) AS 'Efectivo', FORMAT( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ), 2 ) AS 'Tarjeta', FORMAT( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ), 2 ) AS 'Vales', FORMAT( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ), 2 ) AS 'Cheque', FORMAT( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( sum( Abono.Efectivo ) = '' OR sum( Abono.Efectivo ) IS NULL, '0', sum( Abono.Efectivo ) ) ) + ( IF ( sum( Abono.Tarjeta ) = '' OR sum( Abono.Tarjeta ) IS NULL, '0', sum( Abono.Tarjeta ) ) ) + ( IF ( sum( Abono.Vales ) = '' OR sum( Abono.Vales ) IS NULL, '0', sum( Abono.Vales ) ) ) + ( IF ( sum( Abono.Cheque ) = '' OR sum( Abono.Cheque ) IS NULL, '0', sum( Abono.Cheque ) ) ) + ( IF ( sum( Abono.Transferencia ) = '' OR sum( Abono.Transferencia ) IS NULL, '0', sum( Abono.Transferencia ) ) ) ), 2 ) AS 'Total' FROM Abonos AS Abono INNER JOIN Ventas AS Vent ON ( Vent.ID = Abono.IDVenta ) WHERE Abono.ID IN ( SELECT ID FROM abonos WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado <> '{idEmpleado}' AND FechaOperacion > '{ultimaFechaDeCorte}' AND IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{idEmpleado}' AND FormaPago = 'Crédito' AND FechaOperacion > '{ultimaFechaDeCorte}' ) ) )";
        ...
        {
            var consulta = $"SELECT CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ), 2 ) ) AS 'Efectivo', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Tarjeta', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Vales', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Cheque', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Transferencia', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ), 2 ) ) AS 'Total', CONCAT( '$ ', FORMAT( ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ), 2 ) ) AS 'Retiro', CONCAT( '$ ', FORMAT( ( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ) ) ) - ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ), 2 ) ) AS 'Resto'";
