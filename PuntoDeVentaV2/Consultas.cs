...
namespace PuntoDeVentaV2
{
    class Consultas
    {
        ...
        public string guarda_datos_faltantes_xml(int opc, string[] datos)
        {
            ...
            if (opc == 7)
            {
                modif = $"INSERT INTO Facturas_impuestos (id_factura_producto, tipo, impuesto, tipo_factor, tasa_cuota, definir, importe) VALUES ('{Convert.ToInt32(datos[0])}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}')";
            }
        ...
        public string GuardarHistorialPrecios(string[] datos)
       {
        ...
        {
            string cons = $"SELECT * FROM detallesfacturacionproductos WHERE IDProducto = {id}"; Console.WriteLine(cons);
