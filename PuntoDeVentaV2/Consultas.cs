...
namespace PuntoDeVentaV2
{
    class Consultas
    {
        ...
        public string GuardarHistorialPrecios(string[] datos)
       {
        ...
        {
            var consulta = $"SELECT CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF(Efectivo='' OR Efectivo IS NULL, '0', SUM(Efectivo)) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Efectivo', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF(Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta )) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Tarjeta', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF(vales='' OR Vales IS NULL, '0', SUM( Vales )) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Vales', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF(Cheque='' OR Cheque IS NULL, '', SUM( Cheque )) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Cheque', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF(Transferencia='' OR Transferencia IS NULL, '0', SUM( Transferencia )) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Transferencia', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF(Efectivo='' OR Efectivo IS NULL, '0', SUM( Efectivo )) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Tarjeta='' OR Tarjeta IS NULL, '0', SUM( Tarjeta )) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Vales='' OR Vales IS NULL, '0', SUM( Vales )) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Cheque='' OR Cheque IS NULL, '0', SUM( Cheque )) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Transferencia='' OR Transferencia IS NULL, '0', SUM( Transferencia )) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ), 2 ) ) AS 'Total', CONCAT( '$ ', FORMAT( ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '227525' ), 2 ) ) AS 'Retiro', CONCAT( '$ ', FORMAT( ( ( ( ( ( CONVERT ( ( SELECT IF(Efectivo='' OR Efectivo IS NULL, '0', SUM( Efectivo )) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Efectivo = '' OR Efectivo IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Tarjeta='' OR Tarjeta IS NULL, '0', SUM( Tarjeta )) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Tarjeta = '' OR Tarjeta IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Vales='' OR Vales IS NULL, '0', SUM( Vales )) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Vales = '' OR Vales IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Cheque='' OR Cheque IS NULL, '0', SUM( Cheque )) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Cheque = '' OR Cheque IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) + ( ( ( ( CONVERT ( ( SELECT IF(Transferencia='' OR Transferencia IS NULL, '0', SUM( Transferencia )) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'antipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( Transferencia = '' OR Transferencia IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ) ) ) - ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ), 2 ) ) AS 'Resto'";
