...
namespace PuntoDeVentaV2
{
    class Consultas
    {
        ...
        {
            string consulta = "INSERT INTO Productos(Nombre, Stock, Precio, Categoria, ClaveInterna, CodigoBarras, ClaveProducto, UnidadMedida, TipoDescuento, IDUsuario, ProdImage, Tipo, Base, IVA, Impuesto, NombreAlterno1, NombreAlterno2, StockNecesario, StockMinimo, PrecioCompra, PrecioMayoreo, incluye_impuestos, nombre_ctercero, rfc_ctercero, cp_ctercero, regimen_ctercero, FormatoDeVenta, SoloRenta)";
            consulta += $"VALUES('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}', '{datos[10]}', '{datos[11]}', '{datos[12]}', '{datos[13]}', '{datos[14]}', '{datos[15]}', '{datos[16]}', '{datos[17]}', '{datos[18]}', '{datos[19]}', '{datos[20]}', '{datos[21]}', '{datos[22]}', '{datos[23]}', '{datos[24]}', '{datos[25]}', '{datos[26]}', '{datos[27]}')";
        ...
        public string GuardarVenta(string[] datos, int operacion = 0, int idAnticipo = 0, string ganancia = "0")
        {
            ...
            if (operacion.Equals(0))
            {
                ...
                consulta = "INSERT INTO Ventas (IDUsuario, IDCliente, IDSucursal, Subtotal, IVA16, Total, Descuento, DescuentoGeneral, Anticipo, Folio, Serie, Status, FechaOperacion, IDClienteDescuento, IDEmpleado, FormaPago,IDAnticipo, Ganancia, TiempoEntrega, FechaEntrega,ImpuestosTraslados,ImpuestosRetenidos)";
                consulta += $"VALUES ('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}', '{datos[10]}', '{datos[11]}', '{datos[12]}', '{datos[13]}', '{datos[14]}', '{datos[15]}','{idAnticipo}', '{ganancia}', '{datos[17]}', '{datos[18]}','{datos[19]}','{datos[20]}')";
            }
            else
            {
                //Actualizar venta guardada
                consulta = $"UPDATE Ventas SET IDCliente = '{datos[1]}', Subtotal = '{datos[3]}', IVA16 = '{datos[4]}', Total = '{datos[5]}', Descuento = '{datos[6]}', DescuentoGeneral = '{datos[7]}', Status = '{datos[11]}', FechaOperacion = '{datos[12]}', IDClienteDescuento = '{datos[13]}' , ImpuestosTraslados = '{datos[19]}', ImpuestosRetenidos = '{datos[20]}' WHERE ID = '{operacion}'";
            }
        ...
        public string AjustarProducto(string[] datos, int tipo)
        {
            ...
            if (tipo == 1)
            {
                consulta = "INSERT INTO HistorialCompras (Concepto, Cantidad, ValorUnitario, Precio, FechaLarga, RFCEmisor, NomEmisor, Comentarios, TipoAjuste, FechaOperacion, IDReporte, IDProducto, IDUsuario, IDEmpleado)";
                consulta += $"VALUES ('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}', '{datos[10]}', '{datos[11]}', '{datos[12]}',{FormPrincipal.id_empleado})";
            }

            //Ajustar producto
            if (tipo == 2)
            {
                consulta = "INSERT INTO HistorialCompras (Concepto, Cantidad, Precio, Comentarios, TipoAjuste, FechaOperacion, IDProducto, IDUsuario, Folio, RFCEmisor, NomEmisor, FechaLarga, ConceptoExtra,IDEmpleado)";
                consulta += $"VALUES ('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}', '{datos[10]}', '{datos[11]}', '{datos[12]}',{FormPrincipal.id_empleado})";
            }
        ...
        {
            string consulta = "INSERT INTO Abonos (IDVenta, IDUsuario, Total, Efectivo, Tarjeta, Vales, Cheque, Transferencia, Referencia, FechaOperacion,intereses, cambio,estado,perdonado,restanteIntereses,AnticipoAplicado)";
            consulta += $"VALUES ('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}','{datos[10]}','{datos[11]}','{datos[12]}','{datos[13]}','{datos[14]}','{datos[15]}')";
            return consulta;
        }
        ...
        {
            string consulta = $"INSERT INTO Abonos (IDVenta, IDUsuario, Total, Efectivo, Tarjeta, Vales, Cheque, Transferencia, Referencia, FechaOperacion, IDEmpleado,intereses, cambio,estado,perdonado,restanteIntereses,AnticipoAplicado) VALUES ('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}', '{datos[10]}','{datos[11]}','{datos[12]}','{datos[13]}','{datos[14]}','{datos[15]}','{datos[16]}')";
        ...
        public string guarda_datos_faltantes_xml(int opc, string[] datos)
        {
            ...
            if (opc == 5)
            {
                ...
                modif += "r_rfc, r_razon_social, r_nombre_comercial, r_correo, r_telefono, r_pais, r_estado, r_municipio, r_localidad, r_cp, r_colonia, r_calle, r_num_ext, r_num_int, r_regimen,";
                modif += "folio, serie, tipo_comprobante, exportacion, r_periodicidad_infog, r_meses_infog, r_anio_infog, cfdi_40)";
                modif += $" VALUES ('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}', '{datos[10]}', '{datos[11]}', '{datos[12]}', '{datos[13]}', '{datos[14]}', '{datos[15]}', '{datos[16]}', '{datos[17]}', '{datos[18]}', '{datos[19]}', '{datos[20]}', '{datos[37]}', '{datos[21]}', '{datos[22]}', '{datos[23]}', '{datos[24]}', '{datos[25]}', '{datos[26]}', '{datos[27]}', '{datos[28]}', '{datos[29]}', '{datos[30]}', '{datos[31]}', '{datos[32]}', '{datos[33]}', '{datos[34]}', '{datos[42]}', '{datos[35]}', '{datos[36]}', 'I', '{datos[38]}', '{datos[39]}', '{datos[40]}', '{datos[41]}', '{datos[43]}')";
            }

            // Guarda los productos 
            if (opc == 6)
            {
                modif = $"INSERT INTO Facturas_productos (id_factura, clave_unidad, clave_producto, descripcion, cantidad, precio_u, base, tasa_cuota, importe_iva, descuento, incluye_impuestos, nombre_ctercero, rfc_ctercero, cp_ctercero, regimen_ctercero) VALUES ('{datos[0]}', '{datos[1]}', '{datos[2]}', '{datos[3]}', '{datos[4]}', '{datos[5]}', '{datos[6]}', '{datos[7]}', '{datos[8]}', '{datos[9]}', '{datos[10]}', '{datos[11]}', '{datos[12]}', '{datos[13]}', '{datos[14]}')";
            }
        ...
        public string InsertaDatoDinamico(string claveAgregar, int claveValor, int idUsuario)
        {
            ...
            string claveAgregarCleaned = string.Empty;
            if (claveAgregar.Equals("Proveedor"))
            {
                claveAgregarCleaned = claveAgregar;
            }
            else
            {
        ...
        public string obtener_datos_para_gcpago(int opc, int dato, int id_doc_imp=0, string tipo="")
        {
            string cons = "";
        ...
        public List<string> registrarBasculas(int IdUsuario)
        {
            List<string> basculas = new List<string>()
            {
                $"INSERT INTO basculas ( nombreBascula, puerto, baudRate, dataBits, handshake, parity, stopBits, sendData, idUsuario, predeterminada ) SELECT * FROM ( SELECT 'TORREY L-PCR-20 KG' AS 'nombreBascula', 'COM3' AS 'puerto', '115200' AS 'baudRate', '8 bit' AS 'dataBits', 'None' AS 'handshake', 'None' AS 'parity', 'One' AS 'stopBits', 'P' AS 'sendData', '{ IdUsuario }' AS 'idUsuario', '0' AS 'predeterminada' ) AS tmp WHERE NOT EXISTS ( SELECT nombreBascula FROM basculas WHERE nombreBascula = 'TORREY L-PCR-20 KG' AND idUsuario = '{ IdUsuario }' ) LIMIT 1;",
                $"INSERT INTO basculas ( nombreBascula, puerto, baudRate, dataBits, handshake, parity, stopBits, sendData, idUsuario, predeterminada ) SELECT * FROM ( SELECT 'TORREY L-PCR-40 KG' AS 'nombreBascula', 'COM3' AS 'puerto', '115200' AS 'baudRate', '8 bit' AS 'dataBits', 'None' AS 'handshake', 'None' AS 'parity', 'One' AS 'stopBits', 'P' AS 'sendData', '{ IdUsuario }' AS 'idUsuario', '0' AS 'predeterminada' ) AS tmp WHERE NOT EXISTS ( SELECT nombreBascula FROM basculas WHERE nombreBascula = 'TORREY L-PCR-40 KG' AND idUsuario = '{ IdUsuario }' ) LIMIT 1;",
                $"INSERT INTO basculas ( nombreBascula, puerto, baudRate, dataBits, handshake, parity, stopBits, sendData, idUsuario, predeterminada ) SELECT * FROM ( SELECT 'Rhino BAR-6X 20 KG' AS 'nombreBascula', 'COM3' AS 'puerto', '9600' AS 'baudRate', '8 bit' AS 'dataBits', 'None' AS 'handshake', 'None' AS 'parity', 'One' AS 'stopBits', 'P' AS 'sendData', '{ IdUsuario }' AS 'idUsuario', '0' AS 'predeterminada' ) AS tmp WHERE NOT EXISTS ( SELECT nombreBascula FROM basculas WHERE nombreBascula = 'Rhino BAR-6X 20 KG' AND idUsuario = '{ IdUsuario }' ) LIMIT 1;",
                $"INSERT INTO basculas ( nombreBascula, puerto, baudRate, dataBits, handshake, parity, stopBits, sendData, idUsuario, predeterminada ) SELECT * FROM ( SELECT 'Rhino BAR-8RS 40 KG' AS 'nombreBascula', 'COM3' AS 'puerto', '9600' AS 'baudRate', '8 bit' AS 'dataBits', 'None' AS 'handshake', 'None' AS 'parity', 'One' AS 'stopBits', 'P' AS 'sendData', '{ IdUsuario }' AS 'idUsuario', '0' AS 'predeterminada' ) AS tmp WHERE NOT EXISTS ( SELECT nombreBascula FROM basculas WHERE nombreBascula = 'Rhino BAR-8RS 40 KG' AND idUsuario = '{ IdUsuario }' ) LIMIT 1;"
            };
        ...
        {
            var consulta = $"SELECT DISTINCT Prod.ID, Prod.Nombre, Prod.Stock, Prod.Precio, Prod.ClaveInterna, Prod.CodigoBarras, Prod.Tipo, IFNULL( ProdDetail.Proveedor, 'N/A' ) AS Proveedor, GralDetail.ChckName, GralDetail.Descripcion FROM Productos AS Prod LEFT JOIN Usuarios AS Usr ON Usr.ID = Prod.IDUsuario LEFT JOIN DetallesProducto AS ProdDetail ON ProdDetail.IDProducto = Prod.ID LEFT JOIN Proveedores AS Prov ON Prov.ID = ProdDetail.IDProveedor LEFT JOIN DetallesProductoGenerales AS GralProdDetail ON GralProdDetail.IDProducto = Prod.ID LEFT JOIN DetalleGeneral AS GralDetail ON GralDetail.ID = GralProdDetail.IDDetalleGral LEFT JOIN AppSettings AS AppSet ON AppSet.IDUsuario = GralDetail.IDUsuario LEFT JOIN codigobarrasextras as CBE ON CBE.IDProducto = Prod.ID WHERE Usr.ID = '{FormPrincipal.userID}' AND Prod.`Status` = '1' AND ( Prod.Tipo = 'P' OR Prod.Tipo = 'PQ' OR Prod.Tipo = 'S' ) AND ( Prod.Nombre LIKE '%{busqueda}%' OR Prod.NombreAlterno1 LIKE '%{busqueda}%' OR Prod.NombreAlterno2 LIKE '%{busqueda}%' OR Prod.ClaveInterna LIKE '%{busqueda}%' OR Prod.CodigoBarras LIKE '%{busqueda}%' OR CBE.CodigoBarraExtra LIKE '%{busqueda}%' ) ORDER BY Prod.Nombre ASC; ";
        ...
        {
            var consulta = $"SELECT (vent.Subtotal + vent.IVA16 + vent.IVA8) AS 'Total',Vent.*, Usr.Usuario, IF(Clte.RazonSocial IS NULL, 'PUBLICO GENERAL', Clte.RazonSocial) AS 'Consumidor', IF(Emp.nombre IS NULL, CONCAT(Usr.Usuario, ' (ADMIN)'), CONCAT(Emp.nombre, ' (EMPLEADO)') ) AS 'Vendedor' FROM ventas AS Vent INNER JOIN usuarios AS Usr ON ( Usr.ID = Vent.IDUsuario ) LEFT JOIN clientes AS Clte ON ( Clte.ID = Vent.IDCliente ) LEFT JOIN empleados AS Emp ON ( Emp.ID = Vent.IDEmpleado ) WHERE Vent.`Status` = '{estado}' AND Vent.IDUsuario = '{FormPrincipal.userID}' AND Vent.FechaOperacion BETWEEN '{ultimaFechaDeCorte}.999999' AND '{rangoFechaLimite}.999999' AND Emp.nombre IS NULL GROUP BY ID ORDER BY ID DESC ";
        ...
        {
            string extra = $"Vent.`Status` = '{estado}'";
            string orderBy = "ORDER BY ID DESC";

            if (estado.Equals(2))
            {
                extra = $"(Vent.`Status` = '{estado}' OR Vent.`Status` = '11')";
        ...
        {
            var consulta = $"SELECT ID, Operacion, IDUsuario, IdEmpleado, SUM( Efectivo ) AS 'Efectivo', SUM( Tarjeta ) AS 'Tarjeta', SUM( Vales ) AS 'Vales', SUM( Cheque ) AS 'Cheque', SUM( Transferencia ) AS 'Transferencia', SUM(Credito) - (SELECT COALESCE(SUM(Credito), 0) FROM caja WHERE Operacion = 'retiro' AND Cantidad = 0 AND Saldo = 0 AND IDUsuario = '{FormPrincipal.userID}' AND IdEmpleado = '0' AND ID > '{idUltimoCorteDeCaja}') AS 'Credito', SUM( Anticipo ) AS 'Anticipo', ( SUM( Efectivo ) + SUM( Tarjeta ) + SUM( Vales ) + SUM( Cheque ) + SUM( Transferencia ) + SUM( Credito) - (SELECT COALESCE(SUM(Credito), 0) FROM caja WHERE Operacion = 'retiro' AND Cantidad = 0 AND Saldo = 0 AND IDUsuario = '{FormPrincipal.userID}' AND IdEmpleado = '0' AND ID > '{idUltimoCorteDeCaja}') + SUM( Anticipo ) ) AS 'TotalVentas' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IdEmpleado = '0' AND ID > '{idUltimoCorteDeCaja}' AND Operacion = 'venta'";
        ...
        {
            var consulta = $"( /* ver solo abonos que pertenecen a ventas a credito solo de administrador */ SELECT Abono.ID, IF ( Abono.IDEmpleado = '0', 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) , 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( IF ( Abono.Cambio = '' OR Abono.Cambio IS NULL, '0', Abono.Cambio ), 2 ) AS 'Cambio', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado = '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion >= '{ultimaFechaDeCorte}' AND Abono.IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND `Status` = '3' OR `Status` = '4' OR `Status` = '8' OR `Status` = '9' ) ) UNION ( /* ver solo abonos que pertenecen a ventas a credito solo de administrador pero abonados desde otro usuario */ SELECT Abono.ID, IF ( Emp.nombre = '' OR Emp.nombre IS NULL, 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) , 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( IF ( Abono.Cambio = '' OR Abono.Cambio IS NULL, '0', Abono.Cambio ), 2 ) AS 'Cambio', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) LEFT JOIN empleados AS Emp ON ( Emp.ID = Abono.IDEmpleado ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado != '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion >= '{ultimaFechaDeCorte}' AND Abono.IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND `Status` = '3' OR `Status` = '4' OR `Status` = '8' OR `Status` = '9' ) ) UNION ( /* ver solo abonos que pertenecen a ventas a credito que ya fueron pagadas en su totalidad solo de administrador */ SELECT Abono.ID, IF ( Abono.IDEmpleado = '0', 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) , 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( IF ( Abono.Cambio = '' OR Abono.Cambio IS NULL, '0', Abono.Cambio ), 2 ) AS 'Cambio', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado = '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion >= '{ultimaFechaDeCorte}' AND Abono.IDVenta IN ( SELECT DISTINCT Vent.ID FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Vent.ID = Abono.IDVenta ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado = '0' AND Vent.`Status` = '0' OR Vent.`Status` = '1' OR Vent.`Status` = '6' ) ) UNION ( /* ver solo abonos que pertenecen a ventas a credito que ya fueron pagadas en su totalidad, solo de administrador pero abonados desde otro usuario */ SELECT Abono.ID, IF ( Emp.nombre = '' OR Emp.nombre IS NULL, 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) , 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( IF ( Abono.Cambio = '' OR Abono.Cambio IS NULL, '0', Abono.Cambio ), 2 ) AS 'Cambio', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) LEFT JOIN empleados AS Emp ON ( Emp.ID = Abono.IDEmpleado ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado != '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion >= '{ultimaFechaDeCorte}' )";
        ...
        public string estatusFinalizacionPagoCredito(int idVenta, int status)
        {
            var consulta = $"UPDATE Ventas SET Status = {status} WHERE ID = '{idVenta}' AND IDUsuario = {FormPrincipal.userID} ";
        ...
        {
            var consulta = $"SELECT * FROM anticipos WHERE IDUsuario = {FormPrincipal.userID} AND Cliente LIKE '%{Filtro}%' OR IDUsuario = {FormPrincipal.userID} AND (Status = 1 OR Status = 5) AND Concepto LIKE '%{Filtro}%' ORDER BY ID DESC";
        ...
        {
            var consulta = $"SET lc_time_names = 'es_MX'; SELECT DISTINCT CONCAT( DATE_FORMAT( Vent.FechaOperacion, '%W - %e/%M/%Y' ), ' ', TIME_FORMAT( Vent.FechaOperacion, '%h:%i:%s %p' ) ) AS 'FechaDeCompra', CONCAT( 'Folio: ', Vent.Folio ) AS 'FolioTicket', IF ( Usr.LogoTipo = '' OR Usr.LogoTipo IS NULL, '', Usr.LogoTipo ) AS 'LogoTipo', IF ( Usr.RazonSocial = '' OR Usr.RazonSocial IS NULL, '', Usr.RazonSocial ) AS 'RazonSocial', IF ( Usr.nombre_comercial = '' OR Usr.nombre_comercial IS NULL, '', CONCAT( 'NOMBRE COMERCIAL: ', Usr.nombre_comercial ) ) AS 'NombreComercial', CONCAT( IF ( Usr.Calle = '' OR Usr.Calle IS NULL, '', CONCAT( 'DIRECCION: ', Usr.Calle ) ), IF ( Usr.NoExterior = '' OR Usr.NoExterior IS NULL, '', CONCAT( ' #', Usr.NoExterior ) ), IF ( Usr.NoInterior = '' OR Usr.NoInterior IS NULL, '', CONCAT( ', INTERIOR: ', Usr.NoInterior ) ), IF ( Usr.Municipio = '' OR Usr.Municipio IS NULL, '', CONCAT( ', ', Usr.Municipio ) ), IF ( Usr.Estado = '' OR Usr.Estado IS NULL, '', CONCAT( ', ', Usr.Estado ) ) ) AS 'Direccion1', CONCAT( IF ( Usr.Colonia = '' OR Usr.Colonia IS NULL, '', CONCAT( 'COLONIA: ', Usr.Colonia ) ), IF ( Usr.CodigoPostal = '' OR Usr.CodigoPostal IS NULL, '', CONCAT( ', C.P.:', Usr.CodigoPostal ) ) ) AS 'Direccion2', IF ( Usr.RFC = '' OR Usr.RFC IS NULL, '', Usr.RFC ) AS 'RFC', IF ( Usr.Email = '' OR Usr.Email IS NULL, '', Usr.Email ) AS 'Correo', IF ( Usr.Telefono = '' OR Usr.Telefono IS NULL, '', Usr.Telefono ) AS 'Telefono', IF ( Clte.RazonSocial = '' OR Clte.RazonSocial IS NULL, IF ( Vent.IDCliente = '0', 'PUBLICO GENERAL', '' ), Clte.RazonSocial ) AS 'ClienteNombre', IF ( Clte.RFC = '' OR Clte.RFC IS NULL, IF ( Vent.IDCliente = '0', 'RFC: XAXX010101000', '' ), CONCAT( 'RFC: ', Clte.RFC ) ) AS 'ClienteRFC', CONCAT( IF ( Clte.Calle = '' OR Clte.Calle IS NULL, '', CONCAT( 'DOMICILIO: CALLE/AV.: ', Clte.Calle ) ), IF ( Clte.NoExterior = '' OR Clte.NoExterior IS NULL, '', CONCAT( ' #', Clte.NoExterior ) ), IF ( Clte.NoInterior = '' OR Clte.NoInterior IS NULL, '',      CONCAT( ', INTERIOR: ', Clte.NoInterior ) ), IF ( Clte.Localidad = '' OR Clte.Localidad IS NULL, '', CONCAT( ', LOCALIDAD: ', Clte.Localidad ) ), IF ( Clte.Municipio = '' OR Clte.Municipio IS NULL, '', CONCAT( ', MUNICIPIO: ', Clte.Municipio ) ) ) AS 'ClienteDomicilio', CONCAT( IF ( Clte.Colonia = '' OR Clte.Colonia IS NULL, '', CONCAT( 'COLONIA: ', Clte.Colonia ) ), IF ( Clte.CodigoPostal = '' OR Clte.CodigoPostal IS NULL, '', CONCAT( ', C.P.: ', Clte.CodigoPostal ) ) ) AS 'ClienteColoniaCodigoPostal', IF ( Clte.Email = '' OR Clte.Email IS NULL, '', CONCAT( 'CORREO: ', Clte.Email ) ) AS 'ClienteCorreo', IF ( Clte.Telefono = '' OR Clte.Telefono IS NULL, '', CONCAT( 'TELEFONO: ', Clte.Telefono ) ) AS 'ClienteTelefono', IF ( Vent.FormaPago = '' OR Vent.FormaPago IS NULL, '', CONCAT( 'FORMA DE PAGO: ', UPPER( Vent.FormaPago ) ) ) AS 'FormaDePago', IF ( DetVent.Referencia = '' OR DetVent.Referencia IS NULL, '', CONCAT( 'REFERENCIA: ', UPPER( DetVent.Referencia ) ) ) AS 'Referencia', ProdVent.Cantidad AS 'ProductoCantidad', ProdVent.Nombre AS 'ProductoNombre', CONCAT( '$ ', FORMAT( ProdVent.Precio, 2 ) ) AS 'ProductoPrecio', CONCAT( '$ ', FORMAT( ProdVent.descuento, 2 ) ) AS 'ProductoDescuento', IF ( ( ( ProdVent.Precio * ProdVent.Cantidad ) - ProdVent.descuento ) IS NULL, CONCAT( '$', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( ( ( ProdVent.Precio * ProdVent.Cantidad ) - ProdVent.descuento ), 2 ) ) ) AS 'ProductoImporte', CONCAT( 'Descuento productos: ', IF ( Vent.Descuento IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Vent.Descuento, 2 ) ) ) ) AS 'DescuentosDeProductos', CONCAT( 'TOTAL: ', IF ( Vent.Total IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ), ' ' ), CONCAT( '$ ', FORMAT( Vent.Total, 2 ), ' ' ) ) ) AS 'TotalGeneral', IF ( editarticket.MensajeTicket IS NULL OR editarticket.MensajeTicket = '.' OR editarticket.MensajeTicket = '', '', editarticket.MensajeTicket ) AS 'MensajeDelTicket', IF ( Vent.Folio = '' OR Vent.Folio IS NULL, '', Vent.Folio ) AS 'CodigoBarrasTicketVenta',Vent.Anticipo FROM productosventa AS ProdVent INNER JOIN ventas AS Vent ON ( ProdVent.IDVenta = Vent.ID ) INNER JOIN detallesventa AS DetVent ON ( DetVent.IDVenta = Vent.ID ) INNER JOIN usuarios AS Usr ON ( Usr.ID = Vent.IDUsuario ) INNER JOIN configuracion AS Config ON ( Config.IDUsuario = Usr.ID ) LEFT JOIN clientes AS Clte ON ( Clte.ID = Vent.IDCliente ) LEFT JOIN editarticket ON ( editarticket.IDUsuario = Usr.ID ) WHERE Vent.IDUsuario = '{FormPrincipal.userID}' AND Vent.`Status` = '{estado}' AND ProdVent.IDVenta = '{idPresupuestoRealizado}'";

            return consulta;
        }

        public string imprimirTicketCancelado(int idCencelacionRealizada, int tipoVenta = 3)
        {
            var consulta = $"SET lc_time_names = 'es_MX'; SELECT DISTINCT CONCAT( DATE_FORMAT( Vent.FechaOperacion, '%W - %e/%M/%Y' ), ' ', TIME_FORMAT( Vent.FechaOperacion, '%h:%i:%s %p' ) ) AS 'FechaDeCompra', CONCAT( 'Folio: ', Vent.Folio ) AS 'FolioTicket', IF ( Usr.LogoTipo = '' OR Usr.LogoTipo IS NULL, '', Usr.LogoTipo ) AS 'LogoTipo', IF ( Usr.RazonSocial = '' OR Usr.RazonSocial IS NULL, '', Usr.RazonSocial ) AS 'RazonSocial', IF ( Usr.nombre_comercial = '' OR Usr.nombre_comercial IS NULL, '', CONCAT( 'NOMBRE COMERCIAL: ', Usr.nombre_comercial ) ) AS 'NombreComercial', CONCAT( IF ( Usr.Calle = '' OR Usr.Calle IS NULL, '', CONCAT( 'DIRECCION: ', Usr.Calle ) ), IF ( Usr.NoExterior = '' OR Usr.NoExterior IS NULL, '', CONCAT( ' #', Usr.NoExterior ) ), IF ( Usr.NoInterior = '' OR Usr.NoInterior IS NULL, '', CONCAT( ', INTERIOR: ', Usr.NoInterior ) ), IF ( Usr.Municipio = '' OR Usr.Municipio IS NULL, '', CONCAT( ', ', Usr.Municipio ) ), IF ( Usr.Estado = '' OR Usr.Estado IS NULL, '', CONCAT( ', ', Usr.Estado ) ) ) AS 'Direccion1', CONCAT( IF ( Usr.Colonia = '' OR Usr.Colonia IS NULL, '', CONCAT( 'COLONIA: ', Usr.Colonia ) ), IF ( Usr.CodigoPostal = '' OR Usr.CodigoPostal IS NULL, '', CONCAT( ', C.P.:', Usr.CodigoPostal ) ) ) AS 'Direccion2', IF ( Usr.RFC = '' OR Usr.RFC IS NULL, '', Usr.RFC ) AS 'RFC', IF ( Usr.Email = '' OR Usr.Email IS NULL, '', Usr.Email ) AS 'Correo', IF ( Usr.Telefono = '' OR Usr.Telefono IS NULL, '', Usr.Telefono ) AS 'Telefono', IF ( Clte.RazonSocial = '' OR Clte.RazonSocial IS NULL, IF ( Vent.IDCliente = '0', 'PUBLICO GENERAL', '' ), Clte.RazonSocial ) AS 'ClienteNombre', IF ( Clte.RFC = '' OR Clte.RFC IS NULL, IF ( Vent.IDCliente = '0', 'RFC: XAXX010101000', '' ), CONCAT( 'RFC: ', Clte.RFC ) ) AS 'ClienteRFC', CONCAT( IF ( Clte.Calle = '' OR Clte.Calle IS NULL, '', CONCAT( 'DOMICILIO: CALLE/AV.: ', Clte.Calle ) ), IF ( Clte.NoExterior = '' OR Clte.NoExterior IS NULL, '', CONCAT( ' #', Clte.NoExterior ) ), IF ( Clte.NoInterior = '' OR Clte.NoInterior IS NULL, '', CONCAT( ', INTERIOR: ', Clte.NoInterior ) ), IF ( Clte.Localidad = '' OR Clte.Localidad IS NULL, '', CONCAT( ', LOCALIDAD: ', Clte.Localidad ) ), IF ( Clte.Municipio = '' OR Clte.Municipio IS NULL, '', CONCAT( ', MUNICIPIO: ', Clte.Municipio ) ) ) AS 'ClienteDomicilio', CONCAT( IF ( Clte.Colonia = '' OR Clte.Colonia IS NULL, '', CONCAT( 'COLONIA: ', Clte.Colonia ) ), IF ( Clte.CodigoPostal = '' OR Clte.CodigoPostal IS NULL, '', CONCAT( ', C.P.: ', Clte.CodigoPostal ) ) ) AS 'ClienteColoniaCodigoPostal', IF ( Clte.Email = '' OR Clte.Email IS NULL, '', CONCAT( 'CORREO: ', Clte.Email ) ) AS 'ClienteCorreo', IF ( Clte.Telefono = '' OR Clte.Telefono IS NULL, '', CONCAT( 'TELEFONO: ', Clte.Telefono ) ) AS 'ClienteTelefono', IF ( Vent.FormaPago = '' OR Vent.FormaPago IS NULL, '', CONCAT( 'FORMA DE PAGO: ', UPPER( Vent.FormaPago ) ) ) AS 'FormaDePago', IF ( DetVent.Referencia = '' OR DetVent.Referencia IS NULL, '', CONCAT( 'REFERENCIA: ', UPPER( DetVent.Referencia ) ) ) AS 'Referencia', ProdVent.Cantidad AS 'ProductoCantidad', ProdVent.Nombre AS 'ProductoNombre', CONCAT( '$ ', FORMAT( ProdVent.Precio, 2 ) ) AS 'ProductoPrecio', CONCAT( '$ ', FORMAT( ProdVent.descuento, 2 ) ) AS 'ProductoDescuento', IF ( ( ( ProdVent.Precio * ProdVent.Cantidad ) - ProdVent.descuento ) IS NULL, CONCAT( '$', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( ( ( ProdVent.Precio * ProdVent.Cantidad ) - ProdVent.descuento ), 2 ) ) ) AS 'ProductoImporte', CONCAT( 'Descuento productos: ', IF ( Vent.Descuento IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Vent.Descuento, 2 ) ) ) ) AS 'DescuentosDeProductos', CONCAT( 'TOTAL: ', IF ( Vent.Total IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ), ' ' ), CONCAT( '$ ', FORMAT( Vent.Total, 2 ), ' ' ) ) ) AS 'TotalGeneral', IF ( editarticket.MensajeTicket IS NULL OR editarticket.MensajeTicket = '.' OR editarticket.MensajeTicket = '', '', editarticket.MensajeTicket ) AS 'MensajeDelTicket', IF ( Vent.Folio = '' OR Vent.Folio IS NULL, '', Vent.Folio ) AS 'CodigoBarrasTicketVenta' FROM productosventa AS ProdVent INNER JOIN ventas AS Vent ON ( ProdVent.IDVenta = Vent.ID ) INNER JOIN detallesventa AS DetVent ON ( DetVent.IDVenta = Vent.ID ) INNER JOIN usuarios AS Usr ON ( Usr.ID = Vent.IDUsuario ) INNER JOIN configuracion AS Config ON ( Config.IDUsuario = Usr.ID ) LEFT JOIN clientes AS Clte ON ( Clte.ID = Vent.IDCliente ) LEFT JOIN editarticket ON ( editarticket.IDUsuario = Usr.ID ) WHERE Vent.IDUsuario = '{FormPrincipal.userID}' AND Vent.`Status` = '{tipoVenta}' AND ProdVent.IDVenta = '{idCencelacionRealizada}'";

            return consulta;
        }

        public string imprimirTicketCredito(int idCreditoOtorgado, int tipoVenta = 4)
        {
            var consulta = $"SET lc_time_names = 'es_MX'; SELECT DISTINCT CONCAT( DATE_FORMAT( Vent.FechaOperacion, '%W - %e/%M/%Y' ), ' ', TIME_FORMAT( Vent.FechaOperacion, '%h:%i:%s %p' ) ) AS 'FechaDeCompra', CONCAT( 'Folio: ', Vent.Folio ) AS 'FolioTicket', IF ( Usr.LogoTipo = '' OR Usr.LogoTipo IS NULL, '', Usr.LogoTipo ) AS 'LogoTipo', IF ( Usr.RazonSocial = '' OR Usr.RazonSocial IS NULL, '', Usr.RazonSocial ) AS 'RazonSocial', IF ( Usr.nombre_comercial = '' OR Usr.nombre_comercial IS NULL, '', CONCAT( 'NOMBRE COMERCIAL: ', Usr.nombre_comercial ) ) AS 'NombreComercial', CONCAT( IF ( Usr.Calle = '' OR Usr.Calle IS NULL, '', CONCAT( 'DIRECCION: ', Usr.Calle ) ), IF ( Usr.NoExterior = '' OR Usr.NoExterior IS NULL, '', CONCAT( ' #', Usr.NoExterior ) ), IF ( Usr.NoInterior = '' OR Usr.NoInterior IS NULL, '', CONCAT( ', INTERIOR: ', Usr.NoInterior ) ), IF ( Usr.Municipio = '' OR Usr.Municipio IS NULL, '', CONCAT( ', ', Usr.Municipio ) ), IF ( Usr.Estado = '' OR Usr.Estado IS NULL, '', CONCAT( ', ', Usr.Estado ) ) ) AS 'Direccion1', CONCAT( IF ( Usr.Colonia = '' OR Usr.Colonia IS NULL, '', CONCAT( 'COLONIA: ', Usr.Colonia ) ), IF ( Usr.CodigoPostal = '' OR Usr.CodigoPostal IS NULL, '', CONCAT( ', C.P.:', Usr.CodigoPostal ) ) ) AS 'Direccion2', IF ( Usr.RFC = '' OR Usr.RFC IS NULL, '', Usr.RFC ) AS 'RFC', IF ( Usr.Email = '' OR Usr.Email IS NULL, '', Usr.Email ) AS 'Correo', IF ( Usr.Telefono = '' OR Usr.Telefono IS NULL, '', Usr.Telefono ) AS 'Telefono', IF ( Clte.RazonSocial = '' OR Clte.RazonSocial IS NULL, IF ( Vent.IDCliente = '0', 'PUBLICO GENERAL', '' ), Clte.RazonSocial ) AS 'ClienteNombre', IF ( Clte.RFC = '' OR Clte.RFC IS NULL, IF ( Vent.IDCliente = '0', 'RFC: XAXX010101000', '' ), CONCAT( 'RFC: ', Clte.RFC ) ) AS 'ClienteRFC', CONCAT( IF ( Clte.Calle = '' OR Clte.Calle IS NULL, '', CONCAT( 'DOMICILIO: CALLE/AV.: ', Clte.Calle ) ), IF ( Clte.NoExterior = '' OR Clte.NoExterior IS NULL, '', CONCAT( ' #', Clte.NoExterior ) ), IF ( Clte.NoInterior = '' OR Clte.NoInterior IS NULL, '', CONCAT( ', INTERIOR: ', Clte.NoInterior ) ), IF ( Clte.Localidad = '' OR Clte.Localidad IS NULL, '', CONCAT( ', LOCALIDAD: ', Clte.Localidad ) ), IF ( Clte.Municipio = '' OR Clte.Municipio IS NULL, '', CONCAT( ', MUNICIPIO: ', Clte.Municipio ) ) ) AS 'ClienteDomicilio', CONCAT( IF ( Clte.Colonia = '' OR Clte.Colonia IS NULL, '', CONCAT( 'COLONIA: ', Clte.Colonia ) ), IF ( Clte.CodigoPostal = '' OR Clte.CodigoPostal IS NULL, '', CONCAT( ', C.P.: ', Clte.CodigoPostal ) ) ) AS 'ClienteColoniaCodigoPostal', IF ( Clte.Email = '' OR Clte.Email IS NULL, '', CONCAT( 'CORREO: ', Clte.Email ) ) AS 'ClienteCorreo', IF ( Clte.Telefono = '' OR Clte.Telefono IS NULL, '', CONCAT( 'TELEFONO: ', Clte.Telefono ) ) AS 'ClienteTelefono', IF ( Vent.FormaPago = '' OR Vent.FormaPago IS NULL, '', CONCAT( 'FORMA DE PAGO: ', UPPER( Vent.FormaPago ) ) ) AS 'FormaDePago', IF ( DetVent.Referencia = '' OR DetVent.Referencia IS NULL, '', CONCAT( 'REFERENCIA: ', UPPER( DetVent.Referencia ) ) ) AS 'Referencia', ProdVent.Cantidad AS 'ProductoCantidad', ProdVent.Nombre AS 'ProductoNombre', CONCAT( '$ ', FORMAT( ProdVent.Precio, 2 ) ) AS 'ProductoPrecio', CONCAT( '$ ', FORMAT( ProdVent.descuento, 2 ) ) AS 'ProductoDescuento', IF ( ( ( ProdVent.Precio * ProdVent.Cantidad ) - ProdVent.descuento ) IS NULL, CONCAT( '$', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( ( ( ProdVent.Precio * ProdVent.Cantidad ) - ProdVent.descuento ), 2 ) ) ) AS 'ProductoImporte', CONCAT( 'Descuento productos: ', IF ( Vent.Descuento IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Vent.Descuento, 2 ) ) ) ) AS 'DescuentosDeProductos', CONCAT( 'TOTAL: ', IF ( Vent.Total IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ), ' ' ), CONCAT( '$ ', FORMAT( Vent.Total, 2 ), ' ' ) ) ) AS 'TotalGeneral', IF ( editarticket.MensajeTicket IS NULL OR editarticket.MensajeTicket = '.' OR editarticket.MensajeTicket = '', '', editarticket.MensajeTicket ) AS 'MensajeDelTicket', IF ( Vent.Folio = '' OR Vent.Folio IS NULL, '', Vent.Folio ) AS 'CodigoBarrasTicketVenta' FROM productosventa AS ProdVent INNER JOIN ventas AS Vent ON ( ProdVent.IDVenta = Vent.ID ) INNER JOIN detallesventa AS DetVent ON ( DetVent.IDVenta = Vent.ID ) INNER JOIN usuarios AS Usr ON ( Usr.ID = Vent.IDUsuario ) INNER JOIN configuracion AS Config ON ( Config.IDUsuario = Usr.ID ) LEFT JOIN clientes AS Clte ON ( Clte.ID = Vent.IDCliente ) LEFT JOIN editarticket ON ( editarticket.IDUsuario = Usr.ID ) WHERE Vent.IDUsuario = '{FormPrincipal.userID}' AND Vent.`Status` = '{tipoVenta}' AND ProdVent.IDVenta = '{idCreditoOtorgado}'";
        ...
        {
            var consulta = $"SET lc_time_names = 'es_MX'; SELECT IF ( Usr.RazonSocial = '' OR Usr.RazonSocial IS NULL, '', Usr.RazonSocial ) AS 'RazonSocial', IF ( Box.Operacion = '' OR Box.Operacion IS NULL, '', 'Ticket Retiro' ) AS 'TipoTicket', IF ( Box.FechaOperacion = '' OR Box.FechaOperacion IS NULL, '', CONCAT( 'Fecha: ', ( CONCAT( DATE_FORMAT( Box.FechaOperacion, '%W - %e/%M/%Y' ), '', TIME_FORMAT( Box.FechaOperacion, '%h:%i:%s %p' ) ) ) ) ) AS 'FechaDeposito', IF ( Usr.Usuario = '' OR Usr.Usuario IS NULL, '', CONCAT( 'Empleado: ', Usr.Usuario ) ) AS 'Empleado', IF ( Box.Efectivo = '' OR Box.Efectivo IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Efectivo, 2 ) ) ) AS 'Efectivo', IF ( Box.Tarjeta = '' OR Box.Tarjeta IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Tarjeta, 2 ) ) ) AS 'Tarjeta', IF ( Box.Vales = '' OR Box.Vales IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Vales, 2 ) ) ) AS 'Vales', IF ( Box.Cheque = '' OR Box.Cheque IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Cheque, 2 ) ) ) AS 'Cheque', IF ( Box.Transferencia = '' OR Box.Transferencia IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Transferencia, 2 ) ) ) AS 'Transferencia', IF ( Box.Cantidad = '' OR Box.Cantidad IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Cantidad, 2 ) ) ) AS 'Total', IF ( Box.Concepto = '' OR Box.Concepto IS NULL, '', Box.Concepto ) AS 'Concepto', Box.Comentarios FROM caja AS Box INNER JOIN usuarios AS Usr ON ( Usr.ID = Box.IDUsuario ) WHERE Box.ID = '{idRetiroDinero}'";
        ...
        {
            var consulta = $"SET lc_time_names = 'es_MX'; SELECT IF ( Usr.RazonSocial = '' OR Usr.RazonSocial IS NULL, '', Usr.RazonSocial ) AS 'RazonSocial', IF ( Box.Operacion = '' OR Box.Operacion IS NULL, '', 'Ticket RETIRO' ) AS 'TipoTicket', IF ( Box.FechaOperacion = '' OR Box.FechaOperacion IS NULL, '', CONCAT( 'Fecha: ', ( CONCAT( DATE_FORMAT( Box.FechaOperacion, '%W - %e/%M/%Y' ), '', TIME_FORMAT( Box.FechaOperacion, '%h:%i:%s %p' ) ) ) ) ) AS 'FechaDeposito', IF ( Emp.nombre = '' OR Emp.nombre IS NULL, '', CONCAT( 'Empleado: ', Emp.nombre ) ) AS 'Empleado', IF ( Box.Efectivo = '' OR Box.Efectivo IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Efectivo, 2 ) ) ) AS 'Efectivo', IF ( Box.Tarjeta = '' OR Box.Tarjeta IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Tarjeta, 2 ) ) ) AS 'Tarjeta', IF ( Box.Vales = '' OR Box.Vales IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Vales, 2 ) ) ) AS 'Vales', IF ( Box.Cheque = '' OR Box.Cheque IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Cheque, 2 ) ) ) AS 'Cheque', IF ( Box.Transferencia = '' OR Box.Transferencia IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Transferencia, 2 ) ) ) AS 'Transferencia', IF ( Box.Cantidad = '' OR Box.Cantidad IS NULL, CONCAT( '$ ', FORMAT( 0, 2 ) ), CONCAT( '$ ', FORMAT( Box.Cantidad, 2 ) ) ) AS 'Total', IF ( Box.Concepto = '' OR Box.Concepto IS NULL, '', Box.Concepto ) AS 'Concepto', Box.Comentarios FROM caja AS Box INNER JOIN usuarios AS Usr ON ( Usr.ID = Box.IDUsuario ) INNER JOIN empleados AS Emp ON ( Emp.ID = Box.IdEmpleado ) WHERE Box.ID = '{IdRetiroDinero}'";
        ...
        {
            var consulta = $"SELECT Vent.ID, Vent.Folio, IF ( Vent.IDCliente = 0, 'Público General', Vent.Cliente ) AS 'Cliente', Vent.Total AS 'Importe', Vent.FechaOperacion AS 'Fecha', Vent.IDCliente FROM ventas AS Vent LEFT JOIN clientes AS Clte ON ( Clte.ID = Vent.IDCliente ) WHERE Vent.IDUsuario = '{FormPrincipal.userID}' AND (Vent.`Status` = '2' OR Vent.`Status` = '7') ORDER BY Vent.FechaOperacion DESC";

            if (!string.IsNullOrWhiteSpace(parametroBusqueda))
            {
                consulta = $"SELECT Vent.ID, Vent.Folio, IF ( Vent.IDCliente = 0, 'Público General', Vent.Cliente ) AS 'Cliente', Vent.Total AS 'Importe', Vent.FechaOperacion AS 'Fecha', Vent.IDCliente FROM ventas AS Vent LEFT JOIN clientes AS Clte ON ( Clte.ID = Vent.IDCliente ) WHERE Vent.IDUsuario = '{FormPrincipal.userID}' AND (Vent.`Status` = '2' OR Vent.`Status` = '7') {parametroBusqueda} ORDER BY Vent.FechaOperacion DESC";
            }
        ...
        {
            var consulta = $"SELECT HistCorteCaja.IDCorteDeCaja AS 'ID', HistCorteCaja.FechaOperacion, HistCorteCaja.IDEmpleado AS 'IdEmpleado', Emp.nombre, Usr.Usuario FROM historialcortesdecaja AS HistCorteCaja INNER JOIN caja AS Box ON ( Box.ID = HistCorteCaja.IDCorteDeCaja ) INNER JOIN usuarios AS Usr ON ( Usr.ID = HistCorteCaja.IDUsuario ) LEFT JOIN empleados AS Emp ON ( Emp.ID = HistCorteCaja.IDEmpleado ) WHERE HistCorteCaja.IDUsuario = '{FormPrincipal.userID}' AND HistCorteCaja.FechaOperacion >= '{fechaInicio} 00:00:00' AND HistCorteCaja.FechaOperacion <= '{fechaFinal} 23:59:59' AND HistCorteCaja.PrimerCorte = 1 AND ( ( Usr.Usuario LIKE '%{busqueda}%' AND Emp.nombre IS NULL ) OR ( Emp.nombre LIKE '%{busqueda}%' ) ) ORDER BY HistCorteCaja.FechaOperacion DESC";
        ...
        {
            var consulta = $"SELECT CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) ), 2 ) ) AS 'Efectivo', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Tarjeta', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Vales', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Cheque', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Transferencia', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Total', CONCAT( '$ ', FORMAT( ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ), 2 ) ) AS 'Retiro', CONCAT( '$ ', FORMAT( ( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'venta' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'deposito' ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND  ID >= '{IDCajaFin}' AND Operacion = 'retiro' ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) ) - ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '0' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ), 2 ) ) AS 'Resto'";
        ...
        {
            var consulta = $"SELECT HistCorteCaja.IDCorteDeCaja AS 'ID', HistCorteCaja.FechaOperacion, HistCorteCaja.IDEmpleado AS 'IdEmpleado', Emp.nombre, Usr.Usuario FROM historialcortesdecaja AS HistCorteCaja INNER JOIN caja AS Box ON ( Box.ID = HistCorteCaja.IDCorteDeCaja ) INNER JOIN usuarios AS Usr ON ( Usr.ID = HistCorteCaja.IDUsuario ) LEFT JOIN empleados AS Emp ON ( Emp.ID = HistCorteCaja.IDEmpleado ) WHERE HistCorteCaja.IDUsuario = '{FormPrincipal.userID}' AND HistCorteCaja.IDEmpleado = '{FormPrincipal.id_empleado}' AND HistCorteCaja.FechaOperacion >= '{fechaInicio} 00:00:00' AND HistCorteCaja.PrimerCorte = 1 AND HistCorteCaja.FechaOperacion <= '{fechaFinal} 23:59:59' AND ( Usr.Usuario LIKE '%{busqueda}%' OR Emp.nombre LIKE '%{busqueda}%' ) ORDER BY HistCorteCaja.FechaOperacion DESC";
        ...
        {
            var consulta = $"SELECT CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Efectivo', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Tarjeta', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Vales', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Cheque', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Transferencia', CONCAT( '$ ', FORMAT( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ), 2 ) ) AS 'Total', CONCAT( '$ ', FORMAT( ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ORDER BY ID DESC LIMIT 1 ), 2 ) ) AS 'Retiro', CONCAT( '$ ', FORMAT( ( ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Efectivo ) = '' OR SUM( Efectivo ) IS NULL, '0', SUM( Efectivo ) ) AS 'Efectivo' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialEfectivo = '' OR SaldoInicialEfectivo IS NULL, '0', SaldoInicialEfectivo ) AS 'Efectivo' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Tarjeta ) = '' OR SUM( Tarjeta ) IS NULL, '0', SUM( Tarjeta ) ) AS 'Tarjeta' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTarjeta = '' OR SaldoInicialTarjeta IS NULL, '0', SaldoInicialTarjeta ) AS 'Tarjeta' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Vales ) = '' OR SUM( Vales ) IS NULL, '0', SUM( Vales ) ) AS 'Vales' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialVales = '' OR SaldoInicialVales IS NULL, '0', SaldoInicialVales ) AS 'Vales' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Cheque ) = '' OR SUM( Cheque ) IS NULL, '0', SUM( Cheque ) ) AS 'Cheque' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialCheque = '' OR SaldoInicialCheque IS NULL, '0', SaldoInicialCheque ) AS 'Cheque' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) + ( ( ( ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'venta' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'anticipo' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) + ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'deposito' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) - ( CONVERT ( ( SELECT IF ( SUM( Transferencia ) = '' OR SUM( Transferencia ) IS NULL, '0', SUM( Transferencia ) ) AS 'Transferencia' FROM caja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND ID <= '{IDCajaInicio}' AND ID >= '{IDCajaFin}' AND Operacion = 'retiro' ORDER BY ID DESC LIMIT 1 ), DECIMAL ) ) ) + ( SELECT IF ( SaldoInicialTransferencia = '' OR SaldoInicialTransferencia IS NULL, '0', SaldoInicialTransferencia ) AS 'Transferencia' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaFin}' ORDER BY ID DESC LIMIT 1 ) ) ) - ( SELECT IF ( CantidadRetiradaDelCorte = '' OR CantidadRetiradaDelCorte IS NULL, '0', CantidadRetiradaDelCorte ) AS 'Retiro' FROM historialcortesdecaja WHERE IDUsuario = '{FormPrincipal.userID}' AND IDEmpleado = '{FormPrincipal.id_empleado}' AND IDCorteDeCaja = '{IDCajaInicio}' ORDER BY ID DESC LIMIT 1 ), 2 ) ) AS 'Resto'";
