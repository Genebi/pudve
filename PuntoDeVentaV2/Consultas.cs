...
namespace PuntoDeVentaV2
{
    class Consultas
    {
        ...
        public string GuardarHistorialPrecios(string[] datos)
       {
        ...
        {
            var consulta = $"( SELECT FORMAT( IF ( sum( Efectivo ) = '' OR sum( Efectivo ) IS NULL, '0', sum( Efectivo ) ), 2 ) AS 'Efectivo', FORMAT( IF ( sum( Tarjeta ) = '' OR sum( Tarjeta ) IS NULL, '0', sum( Tarjeta ) ), 2 ) AS 'Tarjeta', FORMAT( IF ( sum( Vales ) = '' OR sum( Vales ) IS NULL, '0', sum( Vales ) ), 2 ) AS 'Vales', FORMAT( IF ( sum( Cheque ) = '' OR sum( Cheque ) IS NULL, '0', sum( Cheque ) ), 2 ) AS 'Cheque', FORMAT( IF ( sum( Transferencia ) = '' OR sum( Transferencia ) IS NULL, '0', sum( Transferencia ) ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( sum( Efectivo ) = '' OR sum( Efectivo ) IS NULL, '0', sum( Efectivo ) ) ) + ( IF ( sum( Tarjeta ) = '' OR sum( Tarjeta ) IS NULL, '0', sum( Tarjeta ) ) ) + ( IF ( sum( Vales ) = '' OR sum( Vales ) IS NULL, '0', sum( Vales ) ) ) + ( IF ( sum( Cheque ) = '' OR sum( Cheque ) IS NULL, '0', sum( Cheque ) ) ) + ( IF ( sum( Transferencia ) = '' OR sum( Transferencia ) IS NULL, '0', sum( Transferencia ) ) ) ), 2 ) AS 'Total' FROM Abonos WHERE IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND FormaPago = 'Crédito' AND FechaOperacion > '{ultimaFechaDeCorte}' ) AND IDEmpleado = '0' ) UNION DISTINCT ( SELECT FORMAT( IF ( sum( Efectivo ) = '' OR sum( Efectivo ) IS NULL, '0', sum( Efectivo ) ), 2 ) AS 'Efectivo', FORMAT( IF ( sum( Tarjeta ) = '' OR sum( Tarjeta ) IS NULL, '0', sum( Tarjeta ) ), 2 ) AS 'Tarjeta', FORMAT( IF ( sum( Vales ) = '' OR sum( Vales ) IS NULL, '0', sum( Vales ) ), 2 ) AS 'Vales', FORMAT( IF ( sum( Cheque ) = '' OR sum( Cheque ) IS NULL, '0', sum( Cheque ) ), 2 ) AS 'Cheque', FORMAT( IF ( sum( Transferencia ) = '' OR sum( Transferencia ) IS NULL, '0', sum( Transferencia ) ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( sum( Efectivo ) = '' OR sum( Efectivo ) IS NULL, '0', sum( Efectivo ) ) ) + ( IF ( sum( Tarjeta ) = '' OR sum( Tarjeta ) IS NULL, '0', sum( Tarjeta ) ) ) + ( IF ( sum( Vales ) = '' OR sum( Vales ) IS NULL, '0', sum( Vales ) ) ) + ( IF ( sum( Cheque ) = '' OR sum( Cheque ) IS NULL, '0', sum( Cheque ) ) ) + ( IF ( sum( Transferencia ) = '' OR sum( Transferencia ) IS NULL, '0', sum( Transferencia ) ) ) ), 2 ) AS 'Total' FROM Abonos WHERE ID IN ( SELECT ID FROM abonos WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND FechaOperacion > '{ultimaFechaDeCorte}' AND IDVenta NOT IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND FormaPago = 'Crédito' AND FechaOperacion > '{ultimaFechaDeCorte}' ) ) )";
