...
namespace PuntoDeVentaV2
{
    class Consultas
    {
        ...
        public string GuardarHistorialPrecios(string[] datos)
       {
        ...
        {
            var consulta = $"( /* ver solo abonos que pertenecen a ventas a credito solo de administrador */ SELECT Abono.ID, IF ( Abono.IDEmpleado = '0', 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ), 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado = '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion > '{ultimaFechaDeCorte}' AND Abono.IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND `Status` = '4'  ) ) UNION ( /* ver solo abonos que pertenecen a ventas a credito solo de administrador pero abonados desde otro usuario */ SELECT Abono.ID, IF ( Emp.nombre = '' OR Emp.nombre IS NULL, 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ), 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) LEFT JOIN empleados AS Emp ON ( Emp.ID = Abono.IDEmpleado ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado != '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion > '{ultimaFechaDeCorte}' AND Abono.IDVenta IN ( SELECT ID FROM ventas WHERE IDUsuario = '{idUsuario}' AND IDEmpleado = '0' AND `Status` = '4' ) ) UNION ( /* ver solo abonos que pertenecen a ventas a credito que ya fueron pagadas en su totalidad solo de administrador */ SELECT Abono.ID, IF ( Abono.IDEmpleado = '0', 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ), 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado = '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion > '{ultimaFechaDeCorte}' AND Abono.IDVenta IN ( SELECT DISTINCT Vent.ID FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Vent.ID = Abono.IDVenta ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado = '0' AND Vent.`Status` = '1' ) ) UNION ( /* ver solo abonos que pertenecen a ventas a credito que ya fueron pagadas en su totalidad, solo de administrador pero abonados desde otro usuario */ SELECT Abono.ID, IF ( Emp.nombre = '' OR Emp.nombre IS NULL, 'Propia', 'Ajena' ) AS 'Propia', Abono.IDVenta, IF ( Abono.IDEmpleado = '' OR Abono.IDEmpleado IS NULL, '0', Abono.IDEmpleado ) AS 'IDEmpleado', FORMAT( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ), 2 ) AS 'Efectivo', FORMAT( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ), 2 ) AS 'Tarjeta', FORMAT( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ), 2 ) AS 'Vales', FORMAT( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ), 2 ) AS 'Cheque', FORMAT( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ), 2 ) AS 'Transferencia', FORMAT( ( ( IF ( Abono.Efectivo = '' OR Abono.Efectivo IS NULL, '0', Abono.Efectivo ) ) + ( IF ( Abono.Tarjeta = '' OR Abono.Tarjeta IS NULL, '0', Abono.Tarjeta ) ) + ( IF ( Abono.Vales = '' OR Abono.Vales IS NULL, '0', Abono.Vales ) ) + ( IF ( Abono.Cheque = '' OR Abono.Cheque IS NULL, '0', Abono.Cheque ) ) + ( IF ( Abono.Transferencia = '' OR Abono.Transferencia IS NULL, '0', Abono.Transferencia ) ) ), 2 ) AS 'Total' FROM ventas AS Vent INNER JOIN abonos AS Abono ON ( Abono.IDVenta = Vent.ID ) LEFT JOIN empleados AS Emp ON ( Emp.ID = Abono.IDEmpleado ) WHERE Vent.IDUsuario = '{idUsuario}' AND Vent.IDEmpleado != '0' AND Vent.FormaPago = 'Crédito' AND Abono.FechaOperacion > '{ultimaFechaDeCorte}' )";
